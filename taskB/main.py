...
from src import summarizer, preprocess, postprocess
from src.util import read_dataset, save_df, read_dataframe
...
pipelines = {
    "preprocessing": [read_dataframe, preprocess.preprocessing, save_df],
    "summ-complete": [read_dataframe, summarizer.summ_complete, save_df],
    "postprocessing": [read_dataframe, postprocess.postprocessing, save_df],
...
parser.add_argument("--header_column", '-hc', type=str,
                    default="section_header", help=f"The column of dialogue data in the given file.")
